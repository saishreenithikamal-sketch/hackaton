from intelligence.agents import agents
...
# 5. Score database agents used by backend marketplace
def calculate_marketplace_score(agent, bid_amount):
    """
    Score a real database agent competing for a task.
    """
    ...
    # Penalties for risky behaviour
    score -= agent.fraud_flags * 5
    score -= agent.disputes * 1

    # Small penalty for expensive bids
    score -= bid_amount * 0.10

    return round(score, 2)


# 6. Test old ranking system
